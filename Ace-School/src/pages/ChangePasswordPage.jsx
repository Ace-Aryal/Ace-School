        ...
        <div class=" ">
          <div class="mt-12 flex flex-col items-center">
            ...
            >
              ...
              <button class="mt-5 tracking-wide font-semibold bg-blue-100 hover:bg-blue-200 text-blue-600 w-full py-4 rounded-lg transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
                <LockOpen />
                <span class="ml-3">
